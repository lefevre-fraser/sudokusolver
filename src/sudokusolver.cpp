...
*    Fraser LeFevre
* Summary: 
*    Work on Sudoku problems with this program.
*
*    Estimated:  4.0 hrs   
*    Actual:     4.0 hrs
*      The hardest part was figuring out the showValues function.
************************************************************************/
...
void guessAndCheck(char board[][9])
{
   ...
   if (possibleCheck(board) && checkBoard(board))
   {
      for (int r = 0; r < 9; r++)
      {
         for (int c = 0; c < 9; c++)
         {
            if (board[r][c] == '0')
            {
               ...
               if (possible)
               {
                  ...
                  if (k == 9 || !possibleCheck(board))
                  {
                     board[r][c] = '0';
                     return;
                  }
               }
               if (!possibleCheck(board))
               {
                  board[r][c] = '0';
                  return;
               }
